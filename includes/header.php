  ...
  <div class="ui inverted vertical masthead center aligned segment">
    <div class="ui container">
      <div class="ui large secondary inverted pointing menu">
        ...
        <div id="menu" class="ui large secondary inverted pointing menu">
          <a class="item" href="index.php">Home</a>
          <a class="item" >About Us</a>
          <a class="item" href="involve.php">Get Involved</a>
          <a class="item">Alum Meet 2016</a>
    ...
    <div class="ui text container">
      <h1 class="ui inverted header">
        AISMV ALUM ASSOCIATION
      </h1>
      <h2>Literally the best thing our school has ever done.</h2>
